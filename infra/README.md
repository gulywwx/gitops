...
```
Developer creates feature branch in infra
    |
    v
git push origin feature/my-change
    |
    v
Open Pull Request  -->  infra GitHub Actions runs automatically:
    |
    |   [Terraform Plan job]
    |   1. Checkout code
...
- A GitHub account
- The infra repository forked to your GitHub account
...
- [Terraform Interview Questions](docs/terraform-interview-questions.md) — 40 questions covering core concepts, state management, modules, CI/CD pipeline, and real-world scenarios with infra references
